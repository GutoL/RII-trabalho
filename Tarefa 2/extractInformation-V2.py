...
coresList = ["azul","vermelho","branco","prata","verde","cinza","amarelo","marinho","preto"
            ]

combustivelList = ["gasolina","flex","alcool"]

cambioList = ["manual","automatico","automatica","c-manual","c-automatico","c-automatica"]

direcaoList = ["mecanica", "hidraulica", "dm", "dh"]

opcionaisList = ['radio', 'CD', 'MP3', 'alarme', 'airbag','travas','vidro',
                 'vidros','eletrica','eletricas','bluetooth','abs','sensores','sensor','couro',
                 'rodas','liga','completo']
################################## Classes ##################################################
